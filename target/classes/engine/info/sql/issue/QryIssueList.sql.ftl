select * from (
	SELECT 
		...
		empfif.name AS assigneeName, issue.assignee,empfif.email As assigneeEmail,
		...
		issue.risk_result_type as riskResultType,issue.risk_latest_date as riskLatestDate,issue.risk_result as riskResult,
